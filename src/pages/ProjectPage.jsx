  ...
  return (
    <div style={{ background: "#dfdfdf" }}>
      ...
      >
        <Page
          offset={0}
          gradient={colorMode === "light" ? "lightGreen" : "darkGreen"}
          bg={useColorModeValue("#C1DEAE", "#519259")}
          onClick={() => scroll(1)}
        />
        <Page
          offset={1}
          gradient={colorMode === "light" ? "lightCreme" : "darkCreme"}
          bg={useColorModeValue("#DBD0C0", "#B68973")}
          onClick={() => scroll(2)}
        />
