...
export default function Path() {
  ...
  const mainBachelor = [
    ...
    " Relational Databases Management Systems (MySQL)",
    "Networking (OSI network model)",
    "Operating Systems (Linux) & bash scripitng",
  ...
  return (
    <Box mt={100}>
      <Center>
        ...
        >
          <Heading p={50}>Education Path</Heading>
        </Box>
      </Center>
      <VerticalTimeline>
        <VerticalTimelineElement
