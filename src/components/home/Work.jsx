    ...
    <Box mt={100}>
      <Center>
        <Box
          ...
          sx={{ border: "solid black 3px", borderRadius: 15, marginBottom: 10 }}
        >
          <Heading p={50}>Work Exprience</Heading>
        </Box>
      </Center>
      <VerticalTimeline>
        <VerticalTimelineElement
        ...
        >
          <Box
            p={15}
            sx={{ background: `mode.${colorMode}.background` }}
            boxShadow="dark-lg"
            shadow="md"
            borderWidth="1px"
            borderRadius="16"
          >
            ...
            <p>
              Development, deployment & maintaining of different SOWIT
              application including Back-end & web application .
            </p>
            <p>
        ...
        >
          ...
          >
            ...
            <p fontSize="xl">
              Development of web application from scratch & scaling it along
              with Test Driven development methodology, development of a
              responsive Front-end with UX practice with Angular & Backend
              service with Django.
            </p>
            <p>
        ...
        >
          ...
          >
            ...
            <p>
              Development and deployment of a Web application that handles the
              delivery management of the collection of parcels.
            </p>
            <p>
              The technologies i'm working with :
              <div
