      ...
      <Box mt={100}>
        ...
        <VerticalTimelineElement
          ...
          >
            <Box p={15}  sx={{ background: `mode.${colorMode}.background`}} boxShadow="dark-lg" shadow="md" borderWidth="1px"  borderRadius="16">
              <h2 style={{ textAlign: "left", marginBottom: "4px", fontWeight: 'bold'}}>
                Full stack developer <br/> 27 july 2021 - present (2 months)
              </h2>
        ...
        <VerticalTimelineElement
          ...
          >
            <Box p={15} sx={{ background: `mode.${colorMode}.background`}} boxShadow="dark-lg" shadow="md" borderWidth="1px"  borderRadius="16">
              <h2 style={{ textAlign: "left", marginBottom: "4px", fontWeight: 'bold'}}>
                Full stack developer <br/>  08 mars 2021 - 31 aug 2021 (6 months)
              </h2>
          ...
          >
            <Box p={15}  sx={{ background: `mode.${colorMode}.background`}} boxShadow="dark-lg" shadow="md" borderWidth="1px"  borderRadius="16">
              <h2 style={{ textAlign: "left", marginBottom: "4px", fontWeight: 'bold'}}>
                Bachelor in computer engineering <br/>  (2020 - 2021)
              </h2>
          ...
          >
            <Box p={15} sx={{ background: `mode.${colorMode}.background`}} boxShadow="dark-lg" shadow="md" borderWidth="1px"  borderRadius="16">
              <h2 className="vertical-timeline-element-title" style={{ textAlign: "left", marginBottom: "4px", fontWeight: 'bold'}}>DEUST MIP (2017 - 2020)</h2>
