        ...
        <Box className={classes.details}>
          <Grid container>
            <Grid item xs={12} md={6}>
              <Box className={classes.details}>
                <img
                  src="https://github-readme-streak-stats.herokuapp.com/?user=na0495&"
                  alt="na0495"
                />
              </Box>
            </Grid>
            <Grid item xs={12} md={6}>
              <Box className={classes.details}>
                <img
                  src="https://github-readme-stats.vercel.app/api?username=na0495&count_private=true&theme=react"
                  alt="na0495"
                />
              </Box>
            </Grid>
